...
| 姓名 | 任務 |
| :---: | :---: |
| 彭晨燿 | 研究計畫、任務分配、取得軟體、安裝軟體、技術學習、撰寫使用手冊、程式開發、程式測試、系統測試 |
| 劉芷林 | 研究計畫、取得軟體、安裝軟體、技術學習、使用者訓練、使用者測試 |
| 曹芷瑄 | 研究計畫、取得軟體、安裝軟體、技術學習、使用者訓練、使用者測試 |
| 陳惜恩 | 研究計畫、技術學習、取得軟體、安裝軟體、撰寫使用手冊、程式開發、程式測試、系統測試 |
